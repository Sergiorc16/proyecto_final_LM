...
const productosBase = [
    {
        ...
        descripcion: 'Sumérgete en un mundo de fantasía oscura. Elden Ring es una colaboración entre FromSoftware y George R. R. Martin. Explora un vasto mundo abierto lleno de enemigos formidables, secretos ocultos y jefes épicos.',
        descuento: true,
        destacado: true,
    ...
    },
    {
        ...
        genero: 'rpg',
        rating: '4.5',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/8/83/Final_Fantasy_XVI.jpg',
        galeria: [
            'https://upload.wikimedia.org/wikipedia/en/8/83/Final_Fantasy_XVI.jpg',
            'https://images.unsplash.com/photo-1614730321146-b6fa6a46bcb4?w=600&h=800&fit=crop'
        ],
        descripcion: 'Experimenta la epopeya de Final Fantasy XVI, donde Clive Rosfield lucha contra los Dominios. Un juego de acción épico ambientado en un mundo donde los cristales y los Eikones (Dominios) controlan el destino.',
        descuento: true,
        destacado: true,
    ...
    },
    {
        ...
        genero: 'accion',
        rating: '4.9',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/a/a1/Spider-Man_2_cover.jpg',
        galeria: [
            'https://upload.wikimedia.org/wikipedia/en/a/a1/Spider-Man_2_cover.jpg',
            'https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=600&h=800&fit=crop'
        ],
        descripcion: 'Vuelve Peter Parker en Spider-Man 2. Enfrenta nuevas amenazas en Nueva York, incluyendo al icónico villano Venom. Experimenta una historia de superhéroes épica con una jugabilidad mejorada.',
        descuento: false,
        destacado: true,
        fechaLanzamiento: 2023
    },
    {
        ...
        genero: 'rpg',
        rating: '4.6',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/e/e8/Starfield_cover_art.jpg',
        galeria: [
            'https://upload.wikimedia.org/wikipedia/en/e/e8/Starfield_cover_art.jpg',
            'https://images.unsplash.com/photo-1444080748397-f442aa95de81?w=600&h=800&fit=crop'
        ],
        descripcion: 'Explora el universo en Starfield, el RPG espacial de Bethesda. Viaja entre constelaciones, crea tu personaje único y descubre los misterios del espacio en un juego de rol de mundo abierto.',
        descuento: false,
        destacado: true,
        fechaLanzamiento: 2023
    },
    {
        ...
        genero: 'carreras',
        rating: '4.7',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/0/01/Forza_Motorsport_2023.jpg',
        galeria: [
        ...
        descripcion: 'Domina las carreras en Forza Motorsport 8 con gráficos de última generación. Corre en circuitos icónicos del mundo con más de 500 vehículos. Una experiencia de carreras de simulación definitiva.',
        descuento: true,
        fechaLanzamiento: 2023
    },
    {
        ...
        genero: 'aventura',
        rating: '4.9',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/0/0d/Zelda_Echoes_of_Wisdom.jpg',
        galeria: [
        ...
        descripcion: 'Zelda: Echoes of Wisdom marca el debut de la Princesa Zelda como protagonista. Resuelve acertijos, explora dungeons y utiliza ecos para cambiar el flujo del juego en esta nueva aventura.',
        descuento: false,
    ...
    },
    {
        ...
        genero: 'aventura',
        rating: '4.8',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/3/33/Super_Mario_Bros_Wonder.jpg',
        galeria: [
        ...
        descripcion: 'Super Mario Bros Wonder llega a Switch con poderes especiales y mundos mágicos. Corre, salta y utiliza nuevos poderes mientras intentas rescatar al Reino Champiñón de una amenaza oscura.',
        descuento: true,
        fechaLanzamiento: 2023
    },
    {
        ...
        descripcion: 'Vive en Night City en el año 2077. Cyberpunk 2077 es un RPG de acción inmersivo donde tus decisiones cambian el destino de la ciudad. Toma misiones, hackea sistemas y construye tu leyenda.',
        descuento: true,
    ...
    },
    {
        ...
        genero: 'accion',
        rating: '4.8',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/3/30/CS2_%28video_game%29.png',
        galeria: [
            'https://upload.wikimedia.org/wikipedia/en/3/30/CS2_%28video_game%29.png'
        ],
        descripcion: 'Counter-Strike 2 llega como secuela del legendario juego competitivo. Compite en equipos 5v5 en maps icónicos con física mejorada y gráficos de última generación. Completamente gratis.',
        descuento: false,
        gratis: true,
        fechaLanzamiento: 2023
    },
    {
        ...
        genero: 'accion',
        rating: '4.9',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/c/c9/God_of_War_Ragnar%C3%B6k_cover.jpg',
        galeria: [
            'https://upload.wikimedia.org/wikipedia/en/c/c9/God_of_War_Ragnar%C3%B6k_cover.jpg',
            'https://images.unsplash.com/photo-1578496481421-da8a201f8e08?w=600&h=800&fit=crop'
        ],
        descripcion: 'God of War Ragnarök es la conclusión épica de la saga nórdica de Kratos. El Ragnarök está aquí. Junto a Atreus, Kratos debe enfrentar su destino más oscuro en esta aventura de acción épica.',
        descuento: true,
        fechaLanzamiento: 2022
    },
    {
        ...
        genero: 'rpg',
        rating: '4.6',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/3/37/Dragon_Age_Veilguard.jpg',
        galeria: [
        ...
        descripcion: 'Dragon Age: The Veilguard es el nuevo RPG de BioWare. Lidera un equipo de héroes contra amenazas antiguas. Toma decisiones que importan en un mundo lleno de magia, dragones y destino.',
        descuento: true,
        fechaLanzamiento: 2024
    },
    {
        ...
        genero: 'accion',
        rating: '4.7',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/b/b8/Black_Myth_Wukong.png',
        galeria: [
        ...
        descripcion: 'Black Myth: Wukong es una epopeya de acción basada en la mitología china. Encarna al Poderoso Rey Mono en una aventura de combate desafiante inspirada en la novela clásica "Viaje al Oeste".',
        descuento: false,
        destacado: true,
        fechaLanzamiento: 2024
    },
    {
        ...
        genero: 'rpg',
        rating: '4.8',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/d/d0/Metaphor_ReFantazio.jpg',
        galeria: [
            'https://upload.wikimedia.org/wikipedia/en/d/d0/Metaphor_ReFantazio.jpg',
            'https://images.unsplash.com/photo-1566576912321-d58ddd641117?w=600&h=800&fit=crop'
        ],
        descripcion: 'Metaphor: ReFantazio del equipo de Persona trae un nuevo RPG de rol único. Forma lazos con aliados en un mundo de fantasía mientras emprendes una misión épica. El próximo gran JRPG.',
        descuento: true,
        destacado: true,
        fechaLanzamiento: 2024
    },
    {
        ...
        genero: 'aventura',
        rating: '4.7',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/f/f5/Indiana_Jones_Great_Circle.jpg',
        galeria: [
            'https://upload.wikimedia.org/wikipedia/en/f/f5/Indiana_Jones_Great_Circle.jpg',
            'https://images.unsplash.com/photo-1614730321146-b6fa6a46bcb4?w=600&h=800&fit=crop'
        ],
        descripcion: 'Indiana Jones and the Great Circle es una aventura de acción de Bethesda. Sigue a Indiana Jones en una misión global buscando artefactos antiguos y enfrentando enemigos mortales.',
        descuento: false,
        destacado: true,
        fechaLanzamiento: 2024
    },
    {
        ...
        genero: 'rpg',
        rating: '4.5',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/4/42/Dragons_Dogma_2_cover_art.jpg',
        galeria: [
            'https://upload.wikimedia.org/wikipedia/en/4/42/Dragons_Dogma_2_cover_art.jpg',
            'https://images.unsplash.com/photo-1578496481421-da8a201f8e08?w=600&h=800&fit=crop'
        ],
        descripcion: "Dragon's Dogma 2 continúa la tradición de combate épico y exploración en un mundo lleno de dragones y criaturas. Crea aliados y enfrenta desafíos legendarios en esta secuela de acción RPG.",
        descuento: true,
        fechaLanzamiento: 2024
    },
    {
        ...
        genero: 'deportes',
        rating: '4.4',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/4/46/College_Football_25_cover.jpg',
        galeria: [
        ...
        descripcion: 'College Football 25 regresa con la jugabilidad realista de EA Sports. Dirige tu equipo universitario a la gloria. Experimenta la pasión del fútbol americano universitario con ciclos de reclutamiento completos.',
        descuento: true,
        fechaLanzamiento: 2024
    },
    {
        ...
        genero: 'deportes',
        rating: '4.5',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/e/e7/EA_Sports_FC_25.jpg',
        galeria: [
        ...
        descripcion: 'EA Sports FC 25 en Switch te permite construir tu equipo de fútbol ideal. Compite en Ultimate Team, juega partidas rápidas y experimenta el fútbol global en tu consola portátil.',
        descuento: true,
        fechaLanzamiento: 2024
    },
    {
        ...
        descripcion: 'Tekken 8 es el próximo capítulo de la legendaria saga de luchas. Domina combos complejos, lucha contra personajes icónicos y compite en línea en este juego de pelea de ritmo rápido.',
        descuento: true,
        fechaLanzamiento: 2024
    },
    {
        ...
        genero: 'rpg',
        rating: '4.7',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/4/42/Persona_3_Reload_Cover.jpg',
        galeria: [
            'https://upload.wikimedia.org/wikipedia/en/4/42/Persona_3_Reload_Cover.jpg',
            'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=600&h=800&fit=crop'
        ],
        descripcion: 'Persona 3 Reload trae el clásico juego de rol a PS5 con una actualización completa. Vive una historia emocionante en una academia mientras luchas contra oscuros misterios sobrenaturales.',
        descuento: true,
        fechaLanzamiento: 2024
    },
    {
        ...
        genero: 'rpg',
        rating: '4.8',
        imagen: 'https://upload.wikimedia.org/wikipedia/en/3/3d/Final_Fantasy_VII_Rebirth_Cover_Art.jpg',
        galeria: [
            'https://upload.wikimedia.org/wikipedia/en/3/3d/Final_Fantasy_VII_Rebirth_Cover_Art.jpg',
            'https://images.unsplash.com/photo-1566576912321-d58ddd641117?w=600&h=800&fit=crop'
        ],
        descripcion: 'Final Fantasy VII Rebirth es la conclusión épica de la trilogía de remake. Cloud y sus aliados continúan su lucha contra Shinra en este RPG de acción con narrativa cinematográfica.',
        descuento: false,
        destacado: true,
        fechaLanzamiento: 2024
    }
...
function abrirRuleta() {
    if (usuarioActual.puntos < 100) {
        alert('Necesitas 100 puntos para girar. Actualmente tienes: ' + usuarioActual.puntos);
        return;
    }
...
function renderizarProductoDetalle() {
    ...
    // Galería
    const galeriaHtml = p.galeria.map((img, idx) => `
    ...
    document.getElementById('product-detail-main-image').innerHTML = imagenPrincipalHtml;
    
    // Información del producto
    document.getElementById('product-detail-name').textContent = p.nombre;
    document.getElementById('product-detail-console').textContent = obtenerNombreConsola(p.consola);
    document.getElementById('product-detail-genre').textContent = p.genero.charAt(0).toUpperCase() + p.genero.slice(1);
    document.getElementById('product-detail-rating').textContent = p.rating;
    document.getElementById('product-detail-year').textContent = p.fechaLanzamiento;
    
    document.getElementById('product-detail-price').textContent = `$${p.precio.toFixed(2)}`;
    if (p.descuento) {
        const descuentoPorcentaje = Math.round(((p.precioOriginal - p.precio) / p.precioOriginal) * 100);
        document.getElementById('product-detail-original-price').innerHTML = `<s>$${p.precioOriginal.toFixed(2)}</s> <span style="color: var(--danger);">-${descuentoPorcentaje}%</span>`;
    ...
    document.getElementById('product-detail-description').textContent = p.descripcion;
}
...
function renderizarPerfil() {
    ...
    document.getElementById('profile-name').textContent = usuarioActual.nombre + adminBadge;
    ...
    if (usuarioActual.descuentosDisponibles.length === 0) {
        descuentosContainer.innerHTML = '<p class="no-discounts">No tienes descuentos disponibles. ¡Realiza giros en la ruleta!</p>';
        return;
    }
...
function usarDescuento(index) {
    ...
    if (descuento.tipo === 'descuento') {
        ...
        mostrarMensajeExito(`✓ Descuento de ${descuento.valor}% aplicado al carrito`);
    } else if (descuento.tipo === 'envioGratis') {
...
function obtenerProductos() {
    ...
    if (!filtrosActivos.consolas.includes('all')) {
        productos = productos.filter(p => filtrosActivos.consolas.includes(p.consola));
    }

    // Filtrar por género
    if (filtrosActivos.generos.length > 0) {
        productos = productos.filter(p => filtrosActivos.generos.includes(p.genero));
    }
...
function renderizarProductos(productos = obtenerProductos()) {
    ...
    if (productos.length === 0) {
        grid.innerHTML = '<p style="grid-column: 1/-1; text-align: center; color: #b0b0b0; padding: 40px;">No se encontraron productos con estos filtros.</p>';
        return;
    }
...
function renderizarDescuentos() {
    ...
    grid.innerHTML = mayoresDescuentos.map(producto => `
        <div class="product-card" onclick="abrirProducto(${producto.id})">
            <div class="product-image">
                <img src="${producto.imagen}" alt="${producto.nombre}" class="product-img" onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 300 400%22%3E%3Crect fill=%22%231a1f3a%22 width=%22300%22 height=%22400%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 font-size=%2224%22 fill=%22%230088FF%22 text-anchor=%22middle%22 dominant-baseline=%22middle%22%3E${producto.nombre.substring(0, 20)}%3C/text%3E%3C/svg%3E'">
...
function actualizarCarritoCompleto() {
    ...
    const descuentosDisponibles = document.getElementById('cart-available-discounts');
    const descuentosList = document.getElementById('cart-discounts-list');
    
    const descuentosActivos = usuarioActual.descuentosDisponibles.filter(d => !d.usado);
    if (descuentosActivos.length > 0) {
        descuentosDisponibles.style.display = 'block';
        descuentosList.innerHTML = descuentosActivos.map((descuento, index) => {
            const indiceOriginal = usuarioActual.descuentosDisponibles.indexOf(descuento);
            const isActive = usuarioActual.descuentoActivoIndex === indiceOriginal || 
    ...
    if (usuarioActual.descuentoActual > 0 && usuarioActual.descuentoActivoIndex !== undefined) {
        const descuentoActivo = usuarioActual.descuentosDisponibles[usuarioActual.descuentoActivoIndex];
    ...
    cartPageItems.innerHTML = carrito.map((item, index) => `
...
function actualizarFiltrosConsolas() {
    ...
    const otrosCheckboxes = document.querySelectorAll('.console-filter:not([value="all"])');
...
function limpiarFiltros() {
    ...
    document.querySelectorAll('.console-filter:not([value="all"])').forEach(cb => {
        cb.checked = false;
    });
...
function procesarLogin(event) {
    ...
    if (email === usuarioAdmin.email && password === usuarioAdmin.password) {
        ...
        mostrarMensajeExito(`¡Bienvenido ${usuarioActual.nombre}! 👑 (Panel Administrador)`);
    } else {
        // Usuario regular
        ...
        document.getElementById('login-form').reset();
        mostrarMensajeExito(`¡Bienvenido ${usuarioActual.nombre}! Tienes ${usuarioActual.puntos} puntos`);
    }
...
function actualizarPuntosDisplay() {
    ...
    document.getElementById('spin-btn-home').disabled = usuarioActual.puntos < 100;
    ...
    document.getElementById('progress-fill').style.width = Math.min(porcentaje, 100) + '%';
}
    ...
    const animate = () => {
        ...
        if (progress < 1) {
            ...
            if (premio.descuento) {
                ...
                document.getElementById('ultimo-descuento').textContent = `¡Ganaste ${premio.descuento}% de descuento! Disponible en tu perfil.`;
            } else if (premio.puntos) {
                usuarioActual.puntos += premio.puntos;
                document.getElementById('ultimo-descuento').textContent = `¡Ganaste ${premio.puntos} puntos extras!`;
                ...
                document.getElementById('ultimo-descuento').textContent = `¡Ganaste envío gratis! Disponible en tu perfil.`;
            }
